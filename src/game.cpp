		...
		[&]() {return pInputContext->get_key_just_pressed(keyboard::Key::Escape);})))
{
	...
	for (int i(0); i < 30; ++i) pipes.push_back(flappy::pipe(pGraphicsContext, pGameScene, aAssets));
	...
	static const auto vertical_interval = 1.3f;
